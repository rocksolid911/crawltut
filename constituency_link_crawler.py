...
from crawl4ai import AsyncWebCrawler, CrawlerRunConfig, BrowserConfig, CacheMode, DefaultMarkdownGenerator, \
    PruningContentFilter, LLMContentFilter, LLMConfig
...
async def customcrawler():
    ...
    url = input("Enter URL (press Enter for default 'https://www.myneta.info/LokSabha2024/'): ").strip()
    url = url if url else "https://www.myneta.info/LokSabha2024/"

    # Create folder structure based on URL and user input
    ...
    filter = LLMContentFilter(
        ...
        instruction="""
            Focus on extracting the core  related to election result content.
            Include:
            ...
            """,
        # chunk_token_threshold=10000,  # Adjust based on your needs
        verbose=True
    )
